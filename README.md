# Yeezy Taught Me
Yeezy Taught Me Text Generation. **Web application for Machine Learning Training next character predictions using Long Short Term Memory Model (LSTM) and Time Series Prediction.** Train Long Short Term Memory (LSTM) model to **generate random text** based on patterns in a given text corpus. As Kanye West said:
